...
## Project context
- If a project has no `AGENTS.md` or `CLAUDE.md`, read `.context/` (`README.md`, then `project/`, then `development/`) before working.

## Infrastructure
- Infrastructure work (NAS, Proxmox, VMs, network, Docker, TLS, monitoring, Macs) follows the `nas-ops` repo (`AGENTS.md`/`CLAUDE.md` and `docs/knowledge-graph/`).
